...
const skills = {
  ...
  backend: [
    ...
    { name: 'Scientific Understanding', level: 93 },
    { name: 'Logical Reasoning', level: 100 },
  ],
  DevOps: [
    { name: 'English Debate', level: 80 },
    { name: 'Public Speaking', level: 95 },
    { name: 'Teamwork (Volleyball)', level: 75 },
    { name: 'Organization Skills', level: 80 },
  ],
};
